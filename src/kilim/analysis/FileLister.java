...
/**
 * Utility class to present a uniform iterator interface for file containers;
 * presently includes directories and jar files.
 */
...
public class FileLister implements Iterable<FileLister.Entry> {
     ...
     * @return if the relativeFileName exists in the directory or jar
     *         represented by FileLister object open it. If not return null.
     * @throws IOException
     */
    ...
    private FileContainer openWar(String warFile) throws IOException {
        return openJar(warFile);
    }
